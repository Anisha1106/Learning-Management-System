    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          <h1 className='md:text-course-details-heading-large font-semibold text-gray-800'>{courseData.courseTitle}</h1>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Suhani Chandel</span></p>
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          {playerData ? (
            ...
            <img src={courseData.courseThumbnail || assets.default_course_image} alt="Course thumbnail" />
          )}
